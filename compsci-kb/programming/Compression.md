...
![](../img/compression/io-example.png)
...
For example if we take the [5x5 version](../img/compression/t.jpg) of this image:

![](../img/compression/pixel-image.png)
...
- JPG; Very common [lossy](https://schulichignite.com/definitions/compression/#lossy) image compression
...
- PNG; Common [lossless](https://schulichignite.com/definitions/compression/#lossless) image format that also supports transparency
...
- [Making Things Small | Kieran Wood](https://kieranwood.ca/tech/blog/making-things-small/)
- [The world's smallest PNG (evanhahn.com)](https://evanhahn.com/worlds-smallest-png/)
- [Compression: Crash Course Computer Science #21 - YouTube](https://www.youtube.com/watch?v=OtDxDvCpPL4)
